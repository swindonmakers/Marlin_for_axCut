...
//  float speed_x, speed_y, speed_z, speed_e;        // Nominal mm/sec for each axis
  ...
  #endif
  volatile char busy;
  unsigned char laserUpdate;                // Default to false, set to true to alter laser setting at end of block
  float laserPower;                         // Set to 0 to turn laser off, otherwise will attempt to set laser power
} block_t;
